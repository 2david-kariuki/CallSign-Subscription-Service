...
def subscribe_form():
    ...
    product_name = request.args.get('product_name', 'Call Sign')
    channel_id = request.args.get('channel_id', 'web')
    return render_template('index.html', cp_id=cp_id, product_name=product_name, channel_id=channel_id)
...
def cp_login():
    if request.method == 'POST':
        ...
        if cp_id == "lamahuraan" and password == "secret123":
            session['cp_id'] = cp_id
